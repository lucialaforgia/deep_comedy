...
def train_model(working_dir, model, model_filename, dataset_train, dataset_val, epochs=100, batch_size=32):
    ...
    log_file = os.path.join(logs_dir, "dante_by_char_training_logs.csv")
